...
OUTPUT_PAIRS = PROJECT_ROOT / "data/features/daugman_strict_v3/pairs_features.csv.gz"
OUTPUT_SUMMARY = PROJECT_ROOT / "data/features/daugman_strict_v3/pairs_features_summary.json"
...
def main():
    ...
    print(f"Max unrelated sampled: {args.max_unrelated}")
    print()
    ...
    for i in range(n):
        ...
        for j in range(i + 1, n):
            ...
            if relation == "unrelated":
                ...
                if len(unrelated_reservoir) < args.max_unrelated:
                    unrelated_reservoir.append(pair)
                else:
                    k = random.randint(0, unrelated_seen - 1)
                    if k < args.max_unrelated:
    ...
    summary = {
        ...
        "all_relation_counts": dict(relation_counter_all),
        "selected_relation_counts": dict(relation_counter_selected),
    ...
    print()
    print(f"Salvato pairs in:   {OUTPUT_PAIRS}")
